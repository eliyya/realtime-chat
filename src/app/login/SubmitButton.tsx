    ...
    return (
        <form>
            ...
            {phone 
                ? (
                    <div>
                        ...
                        <input type="text" name='code' required className='text-black' />
                    </div>
                )
                : (
                    <div>
                        <label className='flex flex-col'>phone</label>
                        <input type="text" pattern="\+\d{12}" required name='phone' className='text-black' />
                    </div>
                )}
            <input type="submit" value="submit" onClick={async e => {
                ...
                if (phone) {
                    const x = await props.verify({phone, code: form.get('code') as string})   
